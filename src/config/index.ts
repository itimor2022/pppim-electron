...
export const WS_URL = "wss://www.sbtn.shop/msg_gateway";
export const API_URL = "https://www.sbtn.shop/api";
export const CHAT_URL = "https://www.sbtn.shop/chat";
...
export const APP_VERSION = "三北通 3.5.1";
